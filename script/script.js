...
.fromTo("#T_1", {text: "",y:"40vh", x: "50vw"}, {text: "Un Simple Rêve", duration: 2})
.to("#Simple_reve", {backgroundPosition: "0% 100%", duration:5, ease: "power1.inOut" }, "<")
.to("#T_1", {y: -500, duration: 5,  ease: "power1.inOut"}, "<")
.to(".cloud_holder", {y: -500, duration: 5,  ease: "power1.inOut"}, "<")
.fromTo(".ch1_1", {text: "",y:"60vh", x: "60vw"}, {text: "Une petite fille nommée Jade s'endort lors d'une nuit paisible.", duration: 2},"-=2")
.to(".ch1_1", {y: -500, duration: 5,  ease: "power1.inOut"})
.fromTo(".ch1_2", {text: "",y:"60vh", x: "20vw"}, {text: "Son sommeil l'emporta vers un monde magique.", duration: 2},"-=2")
.to(".ch1_2", {y: -500, duration: 5,  ease: "power1.inOut"})
.fromTo(".ch1_3", {text: "",y:"60vh", x: "40vw"}, {text: "Une forêt enchanté dans lequel elle pourra jouer toute la nuit.", duration: 2},"-=2")
.to(".ch1_3", {y: -500, duration: 5,  ease: "power1.inOut"})
...
.fromTo("#T_2", {text: "",y:"60vh", x: "50vw"}, {text: "La Figure", duration: 2})
.fromTo("#La_figure", {backgroundPosition: "0% 0"}, {backgroundPosition: "100% 0", ease: "none", duration: 20})
.to("#T_2", {x: -500, duration: 5,  ease: "power1.inOut"}, "<")
.fromTo(".noir_ch2", {backgroundPosition: "10% 0", y: -100}, {backgroundPosition: "90% 0", ease: "none", duration: 20}, "<")
.fromTo(".brun_ch2", {backgroundPosition: "0% 0", y: 100}, {backgroundPosition: "100% 0", ease: "none", duration: 20}, "<")
.fromTo(".ch2_1", {text: "",y:"60vh", x: "10vw"}, {text: "Elle se promenait en forêt suivant un sentier de terre, les arbres avait l'air glisser dans le sol.", duration: 2},"-=2")
.fromTo(".girl_ch2", {x: -500}, {x: "50%", ease: "none", duration: 20}, "<")
.fromTo("#monster_sitting", {x: 500}, {x: 0, duration: 3, ease: "none"},"-=3")
.fromTo(".ch2_2", {text: "",y:"70vh", x: "30vw"}, {text: "Une forme noire se trouvais au bout du sentier. Assise et recroqueviller sur elle même.", duration: 2}, "<")
...
.fromTo(".ch2_3", {text: "",y:"90vh", x: "50vw"}, {text: "La figure se déplia et regarda Jade intensément.", duration: 2},"<")
.to("#background_purple", {opacity: 1, duration: 0.1,}, "+=3")
...
.fromTo("#T_3", {text: "",y:"60vh", x: "50vw"}, {text: "Un Danger Mortel", duration: 2})
.to("#T_3", {x: "100vw", duration: 5,  ease: "power1.inOut"})
.fromTo("#La_figure", {backgroundPosition: "100% 0"}, {backgroundPosition: "0% 0", ease: "none", duration: 30}, "<")
.fromTo(".noir_ch2", {backgroundPosition: "90% 0", y: -100}, {backgroundPosition: "10% 0", ease: "none", duration: 30}, "<")
.fromTo(".brun_ch2", {backgroundPosition: "100% 0", y: 100}, {backgroundPosition: "0% 0", ease: "none", duration: 30}, "<")
.fromTo(".girl_ch2", {x: "100vw", opacity:1}, {opacity:1, x: "-100vw", ease: "none", duration: 30}, "<")
.fromTo(".ch3_1", {text: "",y:"70vh", x: "50vw"}, {text: "Jade s'enfuit de l'autre l'autre côté, mais le monstre la poursuivait.", duration: 2},"-=10")
.fromTo("#standing_ch2", {x: "150vw", opacity:1}, {opacity:1, x: "-100vw", ease: "steps(15)", duration: 30}, "<")
.fromTo(".ch3_2", {text: "",y:"80vh", x: "30vw"}, {text: "Ce monstre se téléportait en la suivant.", duration: 2},"-=10")
...
.fromTo("#T_4", {text: "",y:"40vh", x: "10vw"}, {text: "Sans échapatoire", duration: 2})
...
.fromTo("#T_5", {y:"0vh", x: "40vw",scale:0}, {y:"50vw",text: "Sans échapatoire", duration: 2,scale:1})
...
.fromTo("#T_6", {text: "",y:"20vh", x: "40vw"}, {text: "Réveil Brutal", duration: 2})
