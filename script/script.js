...
.fromTo(".ch1_1", {text: "",y:"60vh", right: "10vw"}, {text: "Une petite fille nommée Jade s'endort lors d'une nuit paisible.", duration: 2}, 25)
.to(".ch1_1", {y: -500, duration: 15,  ease: "power1.inOut"}, 35)
.fromTo(".ch1_2", {text: "",y:"60vh", left: "10vw"}, {text: "Son sommeil l'emporta vers un monde magique.", duration: 2}, 40)
.to(".ch1_2", {y: -500, duration: 15,  ease: "power1.inOut"}, 50)
.fromTo(".ch1_3", {text: "",y:"60vh", right: "20vw"}, {text: "Une forêt enchanté dans lequel elle pourra jouer toute la nuit.", duration: 2},55)
...
.fromTo("#T_2", {text: "",y:"60vh", left: 0, right: 0}, {text: "Chapitre 2 La Figure", duration: 10})
.fromTo("#La_figure", {backgroundPosition: "0% 0"}, {backgroundPosition: "100% 0", ease: "none", duration: 40})
.to("#T_2", {left: "-200vw", duration: 10,  ease: "power1.inOut"}, "<")
...
.fromTo(".ch2_1", {text: "",y:"60vh", left: "10vw"}, {text: "Elle se promenait en forêt suivant un sentier de terre, les arbres avait l'air glisser dans le sol.", duration: 20},20)
.fromTo(".girl_ch2", {x: -500}, {x: "50%", ease: "none", duration: 20}, 20)
.fromTo("#monster_sitting", {x: 500}, {x: 0, duration: 10, ease: "none"},40)
.fromTo(".ch2_2", {text: "",y:"70vh", left: "20vw"}, {text: "Une forme noire se trouvais au bout du sentier. Assise et recroqueviller sur elle même.", duration: 10}, 60)
...
.fromTo(".ch2_3", {text: "",y:"80vh", right: "10vw"}, {text: "La figure se déplia et regarda Jade intensément.", duration: 8},80)
.to("#background_purple", {opacity: 1, duration: 0.1,}, 95)
.to(".girl_ch2", {opacity:0, duration: 0.1, rotationY: 180}, 95)
.to(".ch2_1", {opacity:0}, 95)
.to(".ch2_2", {opacity:0}, 95)
.to(".ch2_3", {opacity:0}, 95)
.to("#standing_ch2", {opacity: 0, duration: 0.1,}, 95)
.to("#monster_face", {opacity: 1, duration: 0.1,}, 95)
.to("#monster_face", {duration: 15},95)
.to("#monster_face", {duration: 1, opacity:0}, 110)
.to("#background_purple", {duration: 20, opacity:0},120)
.fromTo("#T_3", {text: "",y:"60vh", left: 0, right: 0}, {text: "Chapitre 3 Un Danger Mortel", duration: 20}, 130)
...
.fromTo(".ch3_1", {text: "",y:"70vh", right: "10vw"}, {text: "Jade s'enfuit de l'autre l'autre côté, mais le monstre la poursuivait.", duration: 20},150)
.fromTo("#standing_ch2", {x: "150vw", opacity:1}, {opacity:1, x: "-100vw", ease: "steps(15)", duration: 30}, 160)
.fromTo(".ch3_2", {text: "",y:"80vh", left: "30vw"}, {text: "Ce monstre se téléportait en la suivant.", duration: 20},170)
...
.fromTo("#T_4", {text: "",y:"40vh", left: "10vw"}, {text: "Chapitre 4 Sans échapatoire", duration: 5}, 0)
.fromTo(".ch4_1", {text: "",top:"45vh", left: "10vw"}, {text: "Les mouvement du monstre devenait de plus en plus erratique.", duration: 10, ease: "none"}, 5)
.fromTo(".ch4_2", {text: "",top:"55vh", left: "10vw"}, {text: "Les arbres aussi avait changé pour des versions plus défformé.", duration: 10, ease: "none"}, 15)
.fromTo(".ch4_3", {text: "",top:"65vh", left: "10vw"}, {text: "Le monstre se rapprochait de plus en plus de Jade...", duration: 10, ease: "none"}, 25)
...
.fromTo("#T_5", {text: "",y:"0vh", left: 0, right: 0,scale:0}, {y:"50vw",text: "Chapitre 5 Sans échapatoire", duration: 2,scale:1, ease:"none"})
...
.fromTo("#T_6", {text: "",y:"50vh", left:0, right: 0}, {text: "Chapitre 6 Réveil Brutal", duration: 5}, 0)
.to("#T_6", {y:"-10vh", duration: 10}, 10)
.to("#Eye_1", {drawSVG:"0% 100%", duration:5, ease:"power1.inOut"}, 12)
.to("#Eye_2", {drawSVG:"0% 100%", duration:5, ease:"power1.inOut"},12)
.to("#Eye_4", {drawSVG:"100% 0%", duration:5, ease:"power1.inOut"}, 20)
.to("#Eye_3", {drawSVG:"100% 0%", duration:5, ease:"power1.inOut"}, 20)
.to("#Eye_1", {morphSVG: "#Close_1", duration:5, ease:"power1.inOut"}, 30)
.to("#Eye_2", {morphSVG: "#Close_2", duration:5, ease:"power1.inOut"}, 30)
.to("#Eye_4", {morphSVG: "#Close_4", duration:5, ease:"power1.inOut"}, 30)
.to("#Eye_3", {morphSVG: "#Close_3", duration:5, ease:"power1.inOut"}, 30)
.to("#bave_path", {scaleY: 1, duration:1, ease:"power1.inOut"})
.fromTo(".ch6_1", {text: "",y:"60vh", left: "30vw"}, {text: "En ouvrant les yeux, le monstre se trouvait au dessus de Jade et bavait du sang sur elle.", duration: 2}, "<")
...
.fromTo("#monstre_smile", {left: "-25vw",scale: 0.1, opacity:0}, {opacity: 1, duration: 2})
.to("#eye_close", {scale: 20, duration: 10,y: "-20vh", x: "190vw"})
.fromTo(".ch6_2", {text: "",bottom:"5vh", left: "30vw"}, {text: "En se rapprochant, le monstre se transforma en livre et tomba.", duration: 2}, "<")
